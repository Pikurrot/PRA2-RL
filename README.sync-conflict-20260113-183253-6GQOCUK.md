...
### Non-cooperative
IQL Non-cooperative:
![IQL Non-cooperative](source code/iql_non_coop.gif)
CQL Non-cooperative:
![CQL Non-cooperative](source code/cql_non_coop.gif)
### Cooperative
IQL Cooperative:
![IQL Cooperative](source code/iql_coop.gif)
CQL Cooperative:
![CQL Cooperative](source code/cql_coop.gif)